...
export default function Root() {
  return (
    <div className="h-full w-full min-h-0 p-lg flex flex-row relative md:overflow-hidden">
      <div className="flex flex-col md:h-170 md:flex-row items-center justify-between">
        ...
        <div className="flex flex-col gap-2xl  items-center md:items-start md:pb-2xl">
          ...
          <Link href="/auth/signup" className="bg-primary mb-10 md:mb-0 py-sm px-md rounded-2xl w-fit text-body md:px-lg md:py-md cursor-pointer hover:brightness-75">Get Started Free</Link>
        </div>
